...
public class AuthenticationServerApp /* extends WebMvcConfigurerAdapter */ {

	// private static final String[] SCOPES_GRANTED = new String[] { "myssoclient"
	// };
	// private static final String[] SCOPES_AUTO_APPROVED = new String[] {
	// "myssoclient" };

	public static void main(String[] args) {
		SpringApplication.run(AuthenticationServerApp.class, args);
	}
	...
	// "password").scopes(SCOPES_GRANTED)
